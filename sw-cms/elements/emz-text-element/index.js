...
Shopware.Service('cmsService').registerCmsElement({
    name: 'emz-text-element',
    label: 'sw-cms.elements.emz-text-element.label',
    component: 'sw-cms-el-emz-text-element',
    configComponent: 'sw-cms-el-config-emz-text-element',
    previewComponent: 'sw-cms-el-preview-emz-text-element',
    defaultConfig: {
        content: {
            source: 'static',
            value: `
