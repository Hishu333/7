import template from './sw-cms-el-config-emz-image-element.html.twig';
import './sw-cms-el-config-emz-image-element.scss';

const { Component } = Shopware;

Component.register('sw-cms-el-config-emz-image-element', {
    template,
    ...
    methods: {
        createdComponent() {
            this.initElementConfig('emz-image-element');
        },
